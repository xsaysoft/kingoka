                    ...
                    <View style={styles.AmountCon}>
                        ...
                        <View style={styles.rowcenter}>
                           {this.state. getCurrency}
                            <Text style={{ color: "#FFF", fontSize: 40, paddingLeft: 5 }}>{Constant.numberFormate(this.state.bal.toFixed(4))}</Text>
        ...
        {this.state.pay_to !=0 ? (
              <View>
                   <Text style={{textAlign: 'right',fontSize:12,color:"#fff"}}>Recipient Gets</Text>
                        ...
                        {Constant.numberFormate(this.state.due_bal.toFixed(5))}
                        </Text>
                        <Text style={{textAlign: 'right',fontSize:20,color:"#fff"}}> {this.state.x_tox} </Text>
                </View>
             ): null }
                    </View>
                 ...
                 <View>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', borderWidth: 1, margin: 15, marginTop: 2, paddingHorizontal: 15 }}>
                        ...
                        <Picker style={{ flex: 0.9, paddingLeft: 150 }}
                            ...
                            onValueChange={(itemValue, itemPosition) => {this.setState({ pay_to: itemValue, toIndex: itemPosition })
                            //GET RATE 
            this.setState({ spinner: true });
